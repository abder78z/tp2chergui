...
CREATE TABLE `formateur` (
  ...
  `nom` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `prenom` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `specialité` varchar(100) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `formateur` (`id_formateur`, `nom`, `prenom`, `specialité`) VALUES
...
CREATE TABLE `formation` (
  ...
  `initule` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `formation` (`id_formation`, `initule`, `duree_heures`, `id_formateur`) VALUES
...
INSERT INTO `inscription` (`id_inscription`, `id_etudiant`, `id_formation`, `date`) VALUES
(1, 1, 3, '2025-11-11'),
(2, 2, 1, '2025-11-03'),
(3, 3, 1, '2025-11-19');
